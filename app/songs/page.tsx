  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-40 px-4 py-3 flex items-center justify-between bg-[#0c1929]/95 backdrop-blur-md border-b border-white/10">
        ...
        <button className="flex items-center justify-center size-10 rounded-full text-white hover:bg-white/10 transition-colors">
      ...
      <main className="flex-1 flex flex-col p-5 gap-6">
        ...
        <div className="flex flex-col items-center text-center gap-1">
          <h1 className="text-2xl font-bold leading-tight tracking-tight text-white">{song.title || "Generating song..."}</h1>
          ...
          <div className="flex flex-col items-center gap-6 pt-2 pb-10">
            ...
            <div className="text-center space-y-8 max-w-xs mx-auto">
              <div className="space-y-3">
                <p className="font-serif text-lg leading-loose text-blue-100/80 whitespace-pre-line">{song.lyrics}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {!song.title && (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-blue-200/70">Composing your song...</p>
          </div>
        )}
      </main>
    </div>
