      ...
      <main className="flex-1 flex flex-col gap-6 pb-12">
        ...
        <section className="flex flex-col pt-6">
          <div className="px-5 mb-4 flex items-baseline justify-between">
            <div>
              ...
              <h2 className="text-2xl font-bold leading-tight tracking-tight text-white">Hidden Meanings</h2>
              <p className="text-sm text-blue-200/70 mt-1">Discover the deeper symbolism in this verse</p>
            </div>
          </div>
          ...
          {imagery.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 px-5">
              ...
              <p className="text-blue-200/70">Discovering symbols...</p>
            </div>
          ) : (
        ...
        <section className="flex flex-col px-5">
          <div className="mb-4">
            ...
            <p className="text-sm text-blue-200/70 mt-1">All {allImages.length} images from your devotional</p>
          </div>
