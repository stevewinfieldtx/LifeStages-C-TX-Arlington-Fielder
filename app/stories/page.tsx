    ...
    >
      ...
      <main className="flex-1 pb-10">
        ...
        <div className="px-6 py-6 mb-2">
          ...
          <p className="text-emerald-400 font-bold text-sm tracking-widest uppercase mb-2">{devotional.verse?.reference}</p>
          <h1 className="text-3xl md:text-4xl font-bold leading-tight text-white">Stories That Hit Home</h1>
          <p className="mt-2 text-blue-200/70">See how this verse plays out in everyday life.</p>
        </div>
        ...
        <div className="px-4 mb-10">
          {!activeStory ? (
            <div className="flex flex-col items-center justify-center py-12 bg-white/5 rounded-2xl border border-white/10">
              ...
              <p className="text-blue-200/70">Crafting story...</p>
            </div>
          ) : (
